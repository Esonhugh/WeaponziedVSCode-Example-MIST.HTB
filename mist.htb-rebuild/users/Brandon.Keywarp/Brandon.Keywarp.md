...
[[ms01]] force authentication with [PKINITtools](https://github.com/dirkjanm/PKINITtools) and Leak [[Sharon.Mullard]]

maybe has same password or something to [[Sharon.Mullard#User Op_Sharon.Mullard]] to PS remote the DC01
